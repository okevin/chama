...
using Chama.Utils.Ionic.Zlib;
using System.IO;


namespace Chama.Utils.Ionic.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        Chama.Utils.Ionic.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="Chama.Utils.Ionic.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="Chama.Utils.Ionic.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private Chama.Utils.Ionic.Crc.CRC32             _runningCrc;
        ...
        private Chama.Utils.Ionic.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="Chama.Utils.Ionic.Zlib.DeflateStream"/>,
        ...
        ///   cref="Chama.Utils.Ionic.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new Chama.Utils.Ionic.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="Chama.Utils.Ionic.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    Chama.Utils.Ionic.Zlib.CRC32 c= new Chama.Utils.Ionic.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                Chama.Utils.Ionic.Crc.CRC32 crc = new Chama.Utils.Ionic.Crc.CRC32();
