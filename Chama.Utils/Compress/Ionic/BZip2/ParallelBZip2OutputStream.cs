...
namespace Chama.Utils.Ionic.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="Chama.Utils.Ionic.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="Chama.Utils.Ionic.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new Chama.Utils.Ionic.BZip2.ParallelBZip2OutputStream(output))
        ///           {
