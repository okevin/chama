...
namespace Chama.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public Chama.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "Chama.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "Chama.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "Chama.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace Chama.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
