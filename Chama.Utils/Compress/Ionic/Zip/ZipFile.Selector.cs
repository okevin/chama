...
namespace Chama.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Chama.Utils.Ionic.FileSelector ff = new Chama.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace Chama.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(Chama.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Chama.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Chama.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Chama.Utils.Ionic.Zip.ZipEntry> SelectEntries(Chama.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Chama.Utils.Ionic.Zip.ZipEntry>();

            foreach (Chama.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Chama.Utils.Ionic.Zip.ZipEntry> SelectEntries(Chama.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
