...
namespace Chama.Utils.Ionic.Zip
{
    public partial class ZipEntry
    {
        ...
        internal static void HandlePK00Prefix(Stream s)
        {
            ...
            uint datum = (uint)Chama.Utils.Ionic.Zip.SharedUtilities.ReadInt(s);
        ...
        private static void HandleUnexpectedDataDescriptor(ZipEntry entry)
        {
            ...
            {
                int sz = Chama.Utils.Ionic.Zip.SharedUtilities.ReadInt(s);
                if (sz == entry._CompressedSize)
                {
                    sz = Chama.Utils.Ionic.Zip.SharedUtilities.ReadInt(s);
