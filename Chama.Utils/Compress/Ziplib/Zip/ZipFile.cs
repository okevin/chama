...
using Chama.Utils.ZipLib.Encryption;
#endif

using Chama.Utils.ZipLib.Core;
using Chama.Utils.ZipLib.Checksums;
using Chama.Utils.ZipLib.Zip.Compression.Streams;
using Chama.Utils.ZipLib.Zip.Compression;

namespace Chama.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Chama.Utils.ZipLib.Zip.ZipException">
