...
using Chama.Utils.EPPlus.Utils;
using System.Xml;
using Chama.Utils.EPPlus.DataValidation.Contracts;

namespace Chama.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit Chama.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
