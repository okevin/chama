...
using Chama.Utils.ExcelLibrary.CompoundDocumentFormat;
using Chama.Utils.ExcelLibrary.BinaryFileFormat;
using Chama.Utils.ExcelLibrary.BinaryDrawingFormat;

namespace Chama.Utils.ExcelLibrary.SpreadSheet
{
