...
namespace Chama.Utils.NPOI.SS.UserModel
{
    ...
    public class PrintOrientation
    {
         ...
         */
        public static PrintOrientation DEFAULT = new PrintOrientation(1);
        /**
         * portrait orientation
         */
        public static PrintOrientation PORTRAIT = new PrintOrientation(2);

        /**
         * landscape orientations
         */
        public static PrintOrientation LANDSCAPE = new PrintOrientation(3);
