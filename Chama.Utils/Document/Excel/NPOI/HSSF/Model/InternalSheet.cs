...
namespace Chama.Utils.NPOI.HSSF.Model
{
    using System;
    ...
    public class InternalSheet
    {
        ...
        /// </summary>
        /// <see cref="Chama.Utils.NPOI.HSSF.Record.DefaultRowHeightRecord"/>
        /// <see cref="Chama.Utils.NPOI.HSSF.Record.Record"/>
 ...
 */
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Chama.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
            ...
            SelectionRecord sel = (SelectionRecord)FindFirstRecordBySid(SelectionRecord.sid);
            sel.Pane = (byte)Chama.Utils.NPOI.SS.UserModel.PanePosition.LOWER_RIGHT;
        ...
        public PaneInformation PaneInformation
        {
            get
            {
                ...
                return new Chama.Utils.NPOI.SS.Util.PaneInformation(rec.X, rec.Y, rec.TopRow,
