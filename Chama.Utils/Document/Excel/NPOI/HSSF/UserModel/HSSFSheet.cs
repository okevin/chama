...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    using Chama.Utils.NPOI.HSSF.Model;
    using Chama.Utils.NPOI.HSSF.Record;
    using Chama.Utils.NPOI.HSSF.Record.Aggregates;
    using Chama.Utils.NPOI.HSSF.Record.AutoFilter;
    using Chama.Utils.NPOI.HSSF.Util;
    using Chama.Utils.NPOI.SS;
    using Chama.Utils.NPOI.SS.Formula;
    using Chama.Utils.NPOI.SS.Formula.PTG;
    using Chama.Utils.NPOI.SS.UserModel;
    using Chama.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : Chama.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, Chama.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="Chama.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, Chama.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="Chama.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(Chama.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public Chama.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            Chama.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public Chama.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(Chama.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(Chama.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public Chama.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    Chama.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new Chama.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="Chama.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public Chama.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, Chama.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, Chama.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, Chama.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, Chama.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, Chama.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                Chama.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                Chama.Utils.NPOI.SS.Util.CellRangeAddress region = (Chama.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(Chama.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    Chama.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, Chama.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Chama.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public Chama.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(Chama.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(Chama.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, Chama.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                Chama.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public Chama.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                Chama.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
