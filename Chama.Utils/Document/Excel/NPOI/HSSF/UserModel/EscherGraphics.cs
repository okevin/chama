...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    public class EscherGraphics : IDisposable
    {
        ...
        private HSSFFont MatchFont(Font font)
        {
            ...
            HSSFFont hssfFont = (HSSFFont)workbook.FindFont(bold ? (short)Chama.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : (short)Chama.Utils.NPOI.SS.UserModel.FontBoldWeight.NORMAL,
                        hssfColor.GetIndex(),
                        (short)(font.Size * 20),
                        font.Name,
                        italic,
                        false,
                        (short)Chama.Utils.NPOI.SS.UserModel.FontSuperScript.NONE,
                        (byte)Chama.Utils.NPOI.SS.UserModel.FontUnderlineType.NONE
                        );
            if (hssfFont == null)
            {
                hssfFont = (HSSFFont)workbook.CreateFont();
                hssfFont.Boldweight = (short)(bold ? Chama.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : 0);
