...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCreationHelper : ICreationHelper
    {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IRichTextString CreateRichTextString(String text)
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IHyperlink CreateHyperlink(HyperlinkType type)
        {
         ...
         */
        public Chama.Utils.NPOI.SS.UserModel.IFormulaEvaluator CreateFormulaEvaluator()
        {
         ...
         * @see Chama.Utils.NPOI.SS.usermodel.Drawing
         */
        public Chama.Utils.NPOI.SS.UserModel.IClientAnchor CreateClientAnchor()
        {
