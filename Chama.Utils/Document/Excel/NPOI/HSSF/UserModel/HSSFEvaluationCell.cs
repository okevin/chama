...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private Chama.Utils.NPOI.SS.UserModel.ICell _cell;

        public HSSFEvaluationCell(Chama.Utils.NPOI.SS.UserModel.ICell cell, IEvaluationSheet evalSheet)
        {
            _cell = cell;
            _evalSheet = evalSheet;
        }
        public HSSFEvaluationCell(Chama.Utils.NPOI.SS.UserModel.ICell cell)
        {
            _cell = cell;
        ...
        {
            Chama.Utils.NPOI.SS.UserModel.ICell cellb = ((HSSFEvaluationCell)obj)._cell;
        ...
        public Chama.Utils.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public Chama.Utils.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
