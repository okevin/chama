...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFPrintSetup :Chama.Utils.NPOI.SS.UserModel.IPrintSetup
    {
        ...
        public Chama.Utils.NPOI.SS.UserModel.DisplayCellErrorType CellError
        {
            get { return (Chama.Utils.NPOI.SS.UserModel.DisplayCellErrorType)printSetupRecord.CellError; }
