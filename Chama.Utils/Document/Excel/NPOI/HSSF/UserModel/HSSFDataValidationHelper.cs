...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFDataValidationHelper : IDataValidationHelper
    {
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateDateConstraint
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateExplicitListConstraint
         * (java.lang.String[])
         */
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateFormulaListConstraint
         * (java.lang.String)
         */
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateNumericConstraint
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTextLengthConstraint
         * (int, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTimeConstraint
         * (int, java.lang.String, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * Chama.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateValidation(org
         * .apache.poi.SS.UserModel.DataValidationConstraint,
         * Chama.Utils.NPOI.SS.Util.CellRangeAddressList)
         */
