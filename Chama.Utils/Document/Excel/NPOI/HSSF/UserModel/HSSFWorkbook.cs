...
namespace Chama.Utils.NPOI.HSSF.UserModel
{
    ...
    using Chama.Utils.NPOI.POIFS.FileSystem;
    using Chama.Utils.NPOI.SS.Formula;
    using Chama.Utils.NPOI.SS.Formula.PTG;
    using Chama.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public Chama.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : Chama.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private Chama.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = Chama.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public Chama.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            Chama.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public Chama.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public Chama.Utils.NPOI.SS.UserModel.Font FindFont(Chama.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 Chama.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, Chama.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public Chama.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                Chama.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public Chama.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public Chama.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public Chama.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public Chama.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, Chama.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case Chama.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case Chama.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case Chama.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case Chama.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case Chama.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case Chama.Utils.NPOI.SS.UserModel.PictureType.DIB:
