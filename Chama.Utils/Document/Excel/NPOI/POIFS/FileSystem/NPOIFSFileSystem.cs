...
using System.IO;
using Chama.Utils.NPOI.POIFS.Common;
using Chama.Utils.NPOI.POIFS.Dev;
using Chama.Utils.NPOI.POIFS.NIO;
using Chama.Utils.NPOI.POIFS.Properties;
using Chama.Utils.NPOI.POIFS.Storage;
using Chama.Utils.NPOI.Util;
using Chama.Utils.NPOI.POIFS.EventFileSystem;

namespace Chama.Utils.NPOI.POIFS.FileSystem
{
