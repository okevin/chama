...
using System.Text;
using Chama.Utils.ZipLib.Zip.Compression.Streams;

namespace Chama.Utils.Gios.Pdf
{
	internal class Utility
	{
		...
		internal static string TextEncode(string text)
		{
			...
			text=text.Replace("?","\\350").Replace("?","\\322").Replace("?","\\323");
			text=text.Replace("?","\\300").Replace("?","\\301").Replace("?","\\307");
			text=text.Replace("?","\\311").Replace("?","\\310").Replace("?","\\314").Replace("?","\\315");
			text=text.Replace("?","\\351").Replace("?","\\362").Replace("?","\\371");
			text=text.Replace("?","\\331").Replace("?","\\332");
			text=text.Replace("?","\\354").Replace("?","\\340").Replace("€","\\200").Replace("?","\\243");
			text=text.Replace("?","\\347").Replace("?","\\272").Replace("?","\\247");
			return text;
		}
